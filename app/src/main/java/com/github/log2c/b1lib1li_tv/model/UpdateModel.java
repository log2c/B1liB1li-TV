...
public class UpdateModel {
    ...
    public void setAssets(List<AssetsModel> assets) {
        this.assets = assets;
    }
    ...
    public static class AssetsModel {
        ...
        private UploaderModel uploader;
        ...
        public void setUploader(UploaderModel uploader) {
        ...
        public static class UploaderModel {
            @SerializedName("login")
            private String login;
            @SerializedName("id")
            private long id;
