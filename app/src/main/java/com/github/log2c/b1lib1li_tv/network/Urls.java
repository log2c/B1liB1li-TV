...
public class Urls {
    ...
    public static final String GET_PLAY_URL = "http://api.bilibili.com/x/player/playurl";// 获取视频流URL（web端）
    public static final String TO_VIEW = "http://api.bilibili.com/x/v2/history/toview";
    public static final String HISTORY = "http://api.bilibili.com/x/web-interface/history/cursor";
    ...
    public static final String SPACE_SEARCH_VIDEOS = "https://api.bilibili.com/x/space/wbi/arc/search"; // 查询用户投稿视频明细
