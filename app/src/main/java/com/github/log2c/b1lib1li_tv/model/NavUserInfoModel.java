...
public class NavUserInfoModel implements Serializable {
    ...
    public LevelInfoModel getLevel_info() {
        return level_info;
    }

    public void setLevel_info(LevelInfoModel level_info) {
    ...
    public OfficialModel getOfficial() {
        return official;
    }

    public void setOfficial(OfficialModel official) {
    ...
    public VipLabelModel getVip_label() {
        return vip_label;
    }

    public void setVip_label(VipLabelModel vip_label) {
    ...
    public WbiImgModel getWbi_img() {
        return wbi_img;
    }

    public void setWbi_img(WbiImgModel wbi_img) {
        this.wbi_img = wbi_img;
    }

    public boolean isIs_jury() {
        return is_jury;
    }

    public void setIs_jury(boolean is_jury) {
        this.is_jury = is_jury;
    }
    ...
    public static class VipLabelModel implements Serializable {
        private String path;
        private String text;
    ...
    public static class WbiImgModel implements Serializable {
